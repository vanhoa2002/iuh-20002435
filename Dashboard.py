...
cred = credentials.Certificate('iuh-20088051-firebase-adminsdk-8oult-315708ed4c.json')
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20088051').stream())
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H4(
                    "Trường: IUH, Lớp: DHHTTT16C, MSSV: 20002435, Tên: HUỲNH THỊ THÙY LINH", className="header-title"
                )
            ],
            className="header",
        ),
